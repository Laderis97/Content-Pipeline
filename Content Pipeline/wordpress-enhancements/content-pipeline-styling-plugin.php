<?php
/**
 * Plugin Name: Content Pipeline Styling
 * Description: Beautiful custom styling for Content Pipeline WordPress site
 * Version: 1.0.0
...
add_action('wp_head', 'content_pipeline_custom_styles');
?>
